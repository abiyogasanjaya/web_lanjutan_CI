...
<body>
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    ...
                                    <form class="row g-3 needs-validation" novalidate method="post" action="<?= base_url('dologin') ?>" enctype="multipart/form-data">
                                        <div class="col-12">
    ...
    <!-- Vendor JS Files -->
    <script src="<?= base_url('assets/backend/vendor/apexcharts/apexcharts.min.js') ?>">
    </script>
    <script src="<?= base_url('assets/backend/vendor/bootstrap/js/bootstrap.bundle.min.js') ?>">
    </script>
    <script src="<?= base_url('assets/backend/vendor/chart.js/chart.umd.js') ?>">
    </script>
    <script src="<?= base_url('assets/backend/vendor/echarts/echarts.min.js') ?>">
    </script>
    <script src="<?= base_url('assets/backend/vendor/quill/quill.min.js') ?>">
    </script>
    <script src="<?= base_url('assets/backend/vendor/simple-datatables/simple-datatables.js') ?>">
    </script>
    <script src="<?= base_url('assets/backend/vendor/tinymce/tinymce.min.js') ?>">
    </script>
    <script src="<?= base_url('assets/backend/vendor/php-email-form/validate.js') ?>">
    </script>
